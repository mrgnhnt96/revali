...
```dart title="lib/components/require_auth.dart"
...
```dart title="routes/controllers/account_controller.dart"
import 'package:revali_router/revali_router.dart';
...
- [Error Handling](./error-handling.md) — return consistent error responses for your own exceptions
