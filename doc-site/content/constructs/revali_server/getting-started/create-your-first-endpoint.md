...
1. **[Run your server](/constructs/revali_server/getting-started/run-the-server)** - Learn about the development server and debugging
2. **Explore more features** - Add parameters, request [bodies](/constructs/revali_server/request/body), and [error handling](/constructs/revali_server/lifecycle-components/advanced/exception-catchers)
