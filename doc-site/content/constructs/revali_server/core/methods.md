...
Learn more about extracting and converting path parameters in the [Binding documentation](/constructs/revali_server/core/binding#param---path-parameters).
...
1. **[Binding](/constructs/revali_server/core/binding)** - Learn how to extract data from requests
2. **[Pipes](/constructs/revali_server/core/pipes)** - Transform and validate request data
3. **[Controllers](/constructs/revali_server/core/controllers)** - Organize your endpoints effectively
