...
<CodeFile name="models/lib/models.dart">
...
<CodeFile name="models/lib/src/user.dart">
...
<CodeFile name="server/pubspec.yaml">
...
<CodeFile name="server/routes/user_controller.dart">
