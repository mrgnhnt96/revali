...
import 'package:revali/server/converters/server_binds_annotation.dart';
import 'package:revali/server/converters/server_body_annotation.dart';
import 'package:revali/server/converters/server_cookie_annotation.dart';
import 'package:revali/server/converters/server_header_annotation.dart';
import 'package:revali/server/converters/server_imports.dart';
import 'package:revali/server/converters/server_ip_annotation.dart';
import 'package:revali/server/converters/server_mimic.dart';
import 'package:revali/server/converters/server_param_annotation.dart';
...
class ServerParamAnnotations with ExtractImport {
    ...
    for (final annotation in <Object?>[
      ...
      if (isOnlyOne) {
        throw ArgumentError(
          ...
          '@Body, @Query, @Header, @Cookie, @Ip, @Param, @Dep, @Binds, @Bind',
        );
      }
  ...
  Iterable<ServerReflect> get reflects sync* {
    ...
    if (ip?.pipe?.reflect case final reflect?) {
      yield reflect;
    }
