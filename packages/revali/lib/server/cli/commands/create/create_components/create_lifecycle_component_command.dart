...
import 'package:revali/server/cli/commands/create/create_components/create_a_component_command.dart';

class CreateLifecycleComponentCommand extends CreateAComponentCommand {
  CreateLifecycleComponentCommand({required super.fs, required super.logger}) {
    argParser.addOption(
      'name',
      abbr: 'n',
