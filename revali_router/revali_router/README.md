...
The [Revali Server documentation](https://docs.revali.dev/constructs/revali_server) provides a comprehensive guide on the classes used within this package. The difference being that you'd be manually creating the server instance instead of using Revali to generate it for you.
